...
Stack: **NestJS** backend, **Next.js** frontend, PostgreSQL, Redis,
BullMQ (or the existing NestJS queue), WebSockets / Socket.IO.
...
Do not invent Django, Celery, or Django Admin patterns.
This product is NestJS + Next.js.
